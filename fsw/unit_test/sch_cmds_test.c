...
void SCH_AppPipe_Test_InvalidCommandCode(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_CC_ERR_EID, CFE_EVS_ERROR_BIT, "Invalid command code: ID = 0x1895, CC = 99"),
...
void SCH_AppPipe_Test_InvalidMessageID(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_MD_ERR_EID, CFE_EVS_ERROR_BIT, "Msg with Invalid message ID Rcvd -- ID = 0x0099"),
...
void SCH_NoopCmd_Test_Nominal(void)
{
    ...
    UtAssert_True (Ut_CFE_EVS_EventSent(SCH_NOOP_CMD_EID, CFE_EVS_INFORMATION_BIT, Message), Message);
...
void SCH_EnableCmd_Test_InvalidArgumentSlotNumber(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_ENABLE_CMD_ARG_ERR_EID, CFE_EVS_ERROR_BIT, "ENABLE cmd: invalid argument, slot=100 (<100), entry=1 (<5)"),
...
void SCH_EnableCmd_Test_InvalidArgumentEntryNumber(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_ENABLE_CMD_ARG_ERR_EID, CFE_EVS_ERROR_BIT, "ENABLE cmd: invalid argument, slot=1 (<100), entry=5 (<5)"),
...
void SCH_EnableCmd_Test_InvalidState(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_ENABLE_CMD_ENTRY_ERR_EID, CFE_EVS_ERROR_BIT, "ENABLE command: invalid state = 99, slot = 0, entry = 0"),
...
void SCH_EnableCmd_Test_Nominal(void)
{
    ...
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_ENABLE_CMD_EID, CFE_EVS_DEBUG_BIT, "ENABLE command: slot = 0, entry = 0"),
        "ENABLE command: invalid state = 99, slot = 0, entry = 0");
...
void SCH_DisableCmd_Test_InvalidArgumentSlotNumber(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_DISABLE_CMD_ARG_ERR_EID, CFE_EVS_ERROR_BIT, "DISABLE cmd: invalid argument, slot=100 (<100), entry=1 (<5)"),
...
void SCH_DisableCmd_Test_InvalidArgumentEntryNumber(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_DISABLE_CMD_ARG_ERR_EID, CFE_EVS_ERROR_BIT, "DISABLE cmd: invalid argument, slot=1 (<100), entry=5 (<5)"),
...
void SCH_DisableCmd_Test_InvalidState(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_DISABLE_CMD_ENTRY_ERR_EID, CFE_EVS_ERROR_BIT, "DISABLE command: invalid state = 99, slot = 0, entry = 0"),
...
void SCH_DisableCmd_Test_Nominal(void)
{
    ...
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_DISABLE_CMD_EID, CFE_EVS_DEBUG_BIT, "DISABLE command: slot = 0, entry = 0"),
        "DISABLE command: invalid state = 99, slot = 0, entry = 0");
...
void SCH_EnableGroupCmd_Test_InvalidArgument(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_ENA_GRP_CMD_ERR_EID, CFE_EVS_ERROR_BIT, "ENABLE GROUP command: invalid argument, no groups selected"),
...
void SCH_EnableGroupCmd_Test_NominalCmdGroupNumberNotUnused(void)
{
    ...
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_ENA_GRP_CMD_EID, CFE_EVS_DEBUG_BIT, "ENABLE GROUP command: match count = 1"),
...
void SCH_EnableGroupCmd_Test_GroupNotFound(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_ENA_GRP_NOT_FOUND_ERR_EID, CFE_EVS_ERROR_BIT, "ENABLE GROUP command: Neither Group 255 nor Multi-Group 0xFFFFFF found"),
...
void SCH_DisableGroupCmd_Test_InvalidArgument(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_DIS_GRP_CMD_ERR_EID, CFE_EVS_ERROR_BIT, "DISABLE GROUP command: invalid argument, no groups selected"),
...
void SCH_DisableGroupCmd_Test_NominalCmdGroupNumberNotUnused(void)
{
    ...
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_DIS_GRP_CMD_EID, CFE_EVS_DEBUG_BIT, "DISABLE GROUP command: match count = 1"),
...
void SCH_DisableGroupCmd_Test_GroupNotFound(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_DIS_GRP_NOT_FOUND_ERR_EID, CFE_EVS_ERROR_BIT, "DISABLE GROUP command: Neither Group 255 nor Multi-Group 0xFFFFFF found"),
...
void SCH_EnableSyncCmd_Test_Nominal(void)
{
    ...
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_ENA_SYNC_CMD_EID, CFE_EVS_DEBUG_BIT, "Major Frame Synchronization Enabled"),
...
void SCH_SendDiagTlmCmd_Test_Enabled(void)
{
    ...
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_SEND_DIAG_CMD_EID, CFE_EVS_DEBUG_BIT, "Transmitting Diagnostic Message"),
...
void SCH_VerifyCmdLength_Test_LengthError(void)
{
    ...
    /* Verify results */
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_CMD_LEN_ERR_EID, CFE_EVS_ERROR_BIT, "Cmd Msg with Bad length Rcvd: ID = 0x1895, CC = 1, Exp Len = 99, Len = 8"),
