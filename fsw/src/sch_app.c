...
void SCH_AppMain(void)
{
    ...
    */
    ...
    if (Status == CFE_SUCCESS)
    {
        ...
        if (Status != CFE_SUCCESS)
        {
            CFE_EVS_SendEvent(SCH_MAJOR_FRAME_SUB_ERR_EID, CFE_EVS_ERROR_BIT,
    ...
    while (CFE_ES_RunLoop(&RunStatus))
    {
        ...
        */
        if (SCH_AppData.IgnoreMajorFrame == true)
        {
            ...
            {
                CFE_EVS_SendEvent(SCH_NOISY_MAJOR_FRAME_ERR_EID, CFE_EVS_ERROR_BIT, 
    ...
    */
    if ((Status != OS_SUCCESS) || (Status != SCH_SUCCESS))
    {
        ...
        */
        CFE_EVS_SendEvent(SCH_APP_EXIT_EID, CFE_EVS_CRITICAL_BIT, 
...
int32 SCH_SbInit(void)
{
    ...
    */
    ...
    if (Status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(SCH_CR_PIPE_ERR_EID, CFE_EVS_ERROR_BIT,
    ...
    */
    ...
    if (Status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(SCH_SUB_HK_REQ_ERR_EID, CFE_EVS_ERROR_BIT,
    ...
    */
    ...
    if (Status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(SCH_SUB_GND_CMD_ERR_EID, CFE_EVS_ERROR_BIT,
...
int32 SCH_TblInit(void)
{
    ...
    */
    ...
    if (Status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(SCH_SDT_REG_ERR_EID, CFE_EVS_ERROR_BIT,
    ...
    */
    ...
    if (Status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(SCH_MDT_REG_ERR_EID, CFE_EVS_ERROR_BIT,
    ...
    */
    ...
    if (Status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(SCH_SDT_LOAD_ERR_EID, CFE_EVS_ERROR_BIT,
    ...
    */
    ...
    if (Status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(SCH_MDT_LOAD_ERR_EID, CFE_EVS_ERROR_BIT,
    ...
    */
    ...
    if (Status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(SCH_ACQ_PTR_ERR_EID, CFE_EVS_ERROR_BIT,
...
int32 SCH_TimerInit(void)
{
    ...
    */
    ...
    if (Status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(SCH_MINOR_FRAME_TIMER_CREATE_ERR_EID, CFE_EVS_ERROR_BIT,
    ...
    */
    ...
    {
        CFE_EVS_SendEvent(SCH_MINOR_FRAME_TIMER_ACC_WARN_EID, CFE_EVS_INFORMATION_BIT,
    ...
    */
    ...
    if (Status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(SCH_SEM_CREATE_ERR_EID, CFE_EVS_ERROR_BIT,
...
int32 SCH_ProcessScheduleTable(void)
{
    ...
    */
    if (ProcessCount == SCH_TOTAL_SLOTS)
    {
        ...
        CFE_EVS_SendEvent(SCH_SAME_SLOT_EID, CFE_EVS_DEBUG_BIT,
    ...
    */
    if (ProcessCount > SCH_MAX_LAG_COUNT)
    {
        ...
        CFE_EVS_SendEvent(SCH_SKIPPED_SLOTS_EID, CFE_EVS_ERROR_BIT,
    ...
    */
    if (ProcessCount > 1)
    {
        ...
        {
            CFE_EVS_SendEvent(SCH_MULTI_SLOTS_EID, CFE_EVS_INFORMATION_BIT,
...
void SCH_ProcessNextEntry(SCH_ScheduleEntry_t *NextEntry, int32 EntryNumber)
{
    ...
    */
        ...
        (NextEntry->Remainder    >= NextEntry->Frequency))
    {
        ...
        */
        CFE_EVS_SendEvent(SCH_CORRUPTION_EID, CFE_EVS_ERROR_BIT,
    ...
    else
    {
        ...
        */
        ...
        if (Remainder == NextEntry->Remainder)
        {
            ...
            Status = CFE_SB_SendMsg((CFE_MSG_Message_t *) Message);
        ...
        */
            ...
            else
            {
                ...
                CFE_EVS_SendEvent(SCH_PACKET_SEND_EID, CFE_EVS_ERROR_BIT,
...
int32 SCH_ProcessCommands(void)
{
    ...
    while (Status == CFE_SUCCESS)
    {
        ...
        */
        ...
        if (Status == CFE_SUCCESS)
        {
            Status = SCH_AppPipe(&SCH_AppData.MsgPtr->Msg);
        }
    }
...
int32 SCH_ValidateScheduleData(void *TableData)
{
    ...
    for (TableIndex = 0; TableIndex < SCH_TABLE_ENTRIES; TableIndex++)
    {
        ...
        */
        if ((EntryResult != CFE_SUCCESS) && (TableResult == CFE_SUCCESS))
        {
            ...
            CFE_EVS_SendEvent(SCH_SCHEDULE_TBL_ERR_EID, CFE_EVS_ERROR_BIT,
    ...
    */
    CFE_EVS_SendEvent(SCH_SCHEDULE_TABLE_EID, CFE_EVS_DEBUG_BIT,
...
int32 SCH_ValidateMessageData(void *TableData)
{
    ...
    for (TableIndex = 0; TableIndex < SCH_MAX_MESSAGES; TableIndex++)
    {
        ...
        */
        if ((EntryResult != CFE_SUCCESS) && (TableResult == CFE_SUCCESS))
        {
            ...
            CFE_EVS_SendEvent(SCH_MESSAGE_TBL_ERR_EID, CFE_EVS_ERROR_BIT,
    ...
    ** Send event describing results
    */
    CFE_EVS_SendEvent(SCH_MESSAGE_TABLE_EID, CFE_EVS_DEBUG_BIT,
